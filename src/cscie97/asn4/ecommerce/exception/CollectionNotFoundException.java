...
/**
 * Exception for problems that the {@link cscie97.asn4.ecommerce.csv.CollectionImporter} may run into during typical
...
public class CollectionNotFoundException extends MobileAppException {
     ...
     * {@link cscie97.asn4.ecommerce.csv.CollectionImporter} class.  Arguments contain more specific details about the
