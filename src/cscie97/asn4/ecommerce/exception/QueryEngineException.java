...
/**
 * Exception for problems that the {@link cscie97.asn4.ecommerce.csv.SearchEngine} may run into during typical
 * query execution.
 *
...
public class QueryEngineException extends Exception {
     ...
     * {@link cscie97.asn4.ecommerce.csv.SearchEngine} class.  Arguments contain more specific details about
